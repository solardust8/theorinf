...
На настоящих демонстрациях можно видеть результат работы кодека сжатия (лдя сравнения с начальным результатом перейдите по [ссылке на базовый кодек](https://ctlab.itmo.ru/gitlab/eabelyaev/cnnimagecodec)) 

Для всех тестов применялась модель, обученная 200 эпох с параметром b=3.

Тесты производились при разном b. Сравнение осуществляется с базовым кодеком осуществляется при b=2.
...
Код модели версии 2 `src/ResAE.py`.
